...
import com.copasso.blog.dto.ErrorCode;
import com.copasso.blog.dto.MetaDto;
...
import com.copasso.blog.utils.IPUtils;
...
public class IndexController extends BaseController {
    ...
    public RestResponseBo comment(HttpServletRequest request, HttpServletResponse response,
        ...
        if (coid != null && coid != 0)
            comment.setAgent(commentService.getCommentById(coid).getAuthor());
        try {
